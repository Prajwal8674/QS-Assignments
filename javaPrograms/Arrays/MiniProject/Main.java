...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        s1[1]= new Student(1,"Rishabh",21,'M',"Hislop",18,2025);
        s1[2]= new Student(2,"Gaurav",24,'M',"KDK",25,2024);
        ...
        System.out.println("4 >> REMOVE FAILED STUDENTS");
        ...
        switch(a){
            ...
            case 3:
                ...
                break;
            case 4:
                System.out.println("       REMOVE FAILED STUDENTS");
                m1.RemoveFail(s1);
                break;
